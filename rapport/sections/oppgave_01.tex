...
As the $+10V$ rises, $U_0$ stays at grounding ($0V$) since theres no current to change it through the resistor. The voltage drop over both branches are the same and the diodes will open at input voltage $0.7V$. We can combine the two branches, the diodes both acts as a $0.7V$ and the resistors can be combined to $1k\Omega$. We then have a voltage divider, which we can calculate $U_0$ and the total current, $I$.
\[
\begin{gathered}
    U_0 = \left(10V - 0.7V\right)\frac{2k\Omega}{1k\Omega + 2k\Omega} \\
    U_0 = 6.2V \\
    I = \frac{9.3V}{1k\Omega + 2k\Omega} \\
    I = 3.1mA
\end{gathered}
\]