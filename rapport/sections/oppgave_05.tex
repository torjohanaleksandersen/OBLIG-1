...
\noindent
The circuit will have no flowing current whenever both diodes are open circuits. When $| U_0(t) | > 0.7V$, there will be current flowing. The absolute max current is as below.
